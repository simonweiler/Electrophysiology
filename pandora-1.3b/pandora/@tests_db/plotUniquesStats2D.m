...
%
% $Id: plotUniquesStats2D.m 1334 2012-04-19 18:02:13Z cengique $
%
...
plot_props.minValue = pop_mean;
plot_props.maxValue = pop_mean + pop_dev;
% $$$ plot_props.colorbarProps = struct;
% $$$ plot_props.colorbarProps.YTickLabel = ...
